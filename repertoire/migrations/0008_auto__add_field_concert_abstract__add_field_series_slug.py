...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concert.abstract'
        db.add_column('repertoire_concert', 'abstract', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Concert.abstract'
        db.delete_column('repertoire_concert', 'abstract')
