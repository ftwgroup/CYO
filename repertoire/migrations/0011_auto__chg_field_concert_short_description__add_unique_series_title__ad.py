...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Concert.short_description'
        db.alter_column('repertoire_concert', 'short_description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Concert.short_description'
        db.alter_column('repertoire_concert', 'short_description', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'repertoire.series': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '128', 'blank': 'True'}),
