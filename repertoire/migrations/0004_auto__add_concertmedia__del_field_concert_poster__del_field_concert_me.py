...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Concert.poster'
        db.delete_column('repertoire_concert', 'poster')

        # Deleting field 'Concert.media_link'
        db.delete_column('repertoire_concert', 'media_link')

        # Adding field 'Concert.concert'
        db.add_column('repertoire_concert', 'concert', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['repertoire.ConcertMedia']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Concert.poster'
        db.add_column('repertoire_concert', 'poster', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Concert.media_link'
        db.add_column('repertoire_concert', 'media_link', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Concert.concert'
        db.delete_column('repertoire_concert', 'concert_id')


    models = {
        'repertoire.concert': {
            'Meta': {'ordering': "['date_time']", 'object_name': 'Concert'},
            'concert': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repertoire.ConcertMedia']"}),
        ...
        'repertoire.concertmedia': {
            'Meta': {'object_name': 'ConcertMedia'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
