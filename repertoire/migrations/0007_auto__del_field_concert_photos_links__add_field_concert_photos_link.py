...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concert.photos_link'
        db.add_column('repertoire_concert', 'photos_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Concert.photos_link'
        db.delete_column('repertoire_concert', 'photos_link')
