...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Concert.time'
        db.delete_column('repertoire_concert', 'time')

        # Deleting field 'Concert.date'
        db.delete_column('repertoire_concert', 'date')

        # Adding field 'Concert.date_time'
        db.add_column('repertoire_concert', 'date_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Concert.time'
        db.add_column('repertoire_concert', 'time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Concert.date'
        db.add_column('repertoire_concert', 'date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Concert.date_time'
        db.delete_column('repertoire_concert', 'date_time')
