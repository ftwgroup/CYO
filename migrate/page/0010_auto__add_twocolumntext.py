...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TwoColumnText'
        db.create_table('page_page_twocolumntext', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='twocolumntext_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('section_title', self.gf('django.db.models.fields.CharField')(max_length='128', null=True, blank=True)),
            ('left_col', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('right_col', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('page', ['TwoColumnText'])


    def backwards(self, orm):
        
        # Deleting model 'TwoColumnText'
        db.delete_table('page_page_twocolumntext')
    ...
    models = {
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 11, 55)'}),
        ...
        'page.twocolumntext': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'TwoColumnText', 'db_table': "'page_page_twocolumntext'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'left_col': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'twocolumntext_set'", 'to': "orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'right_col': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'section_title': ('django.db.models.fields.CharField', [], {'max_length': "'128'", 'null': 'True', 'blank': 'True'})
        }
    }
