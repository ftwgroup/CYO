...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ImageWithText'
        db.delete_table('page_page_imagewithtext')
        ...
        db.create_table('page_page_sectioncontent', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='bio', max_length=10)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Adding model 'ImageWithText'
        db.create_table('page_page_imagewithtext', (
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imagewithtext_set', to=orm['page.Page'])),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('text_body', self.gf('django.db.models.fields.TextField')()),
            ('section_image', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(to=orm['medialibrary.MediaFile'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page', ['ImageWithText'])
    ...
    models = {
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 13, 5)'}),
