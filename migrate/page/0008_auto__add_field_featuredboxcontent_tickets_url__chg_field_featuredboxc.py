...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeaturedBoxContent.tickets_url'
        db.add_column('page_page_featuredboxcontent', 'tickets_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Changing field 'FeaturedBoxContent.series_url'
        db.alter_column('page_page_featuredboxcontent', 'series_url', self.gf('django.db.models.fields.CharField')(max_length=64))


    def backwards(self, orm):
        
        # Deleting field 'FeaturedBoxContent.tickets_url'
        db.delete_column('page_page_featuredboxcontent', 'tickets_url')

        # Changing field 'FeaturedBoxContent.series_url'
        db.alter_column('page_page_featuredboxcontent', 'series_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 20, 2, 45)'}),
