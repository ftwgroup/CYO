...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FeaturedBoxContent.series_url'
        db.alter_column('page_page_featuredboxcontent', 'series_url', self.gf('django.db.models.fields.URLField')(max_length=48))
    ...
    models = {
        ...
        'page.featuredboxcontent': {
            ...
            'series_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 23, 40)'}),
