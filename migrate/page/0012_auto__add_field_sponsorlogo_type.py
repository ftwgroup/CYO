...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SponsorLogo.type'
        db.add_column('page_page_sponsorlogo', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length='32'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SponsorLogo.type'
        db.delete_column('page_page_sponsorlogo', 'type')
    ...
    models = {
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 22, 40)'}),
