...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('page_page', (
            ...
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 19, 23, 35))),
            ...
            ('template_key', self.gf('django.db.models.fields.CharField')(default='generic.html', max_length=255)),
        ))
        ...
        db.create_table('page_page_mediafilecontent', (
            ...
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('type', self.gf('django.db.models.fields.CharField')(default='ArticleImage', max_length=20)),
        ))
