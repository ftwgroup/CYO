...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageWithText.section_image'
        db.add_column('page_page_imagewithtext', 'section_image', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(to=orm['medialibrary.MediaFile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageWithText.section_image'
        db.delete_column('page_page_imagewithtext', 'section_image_id')
    ...
    models = {
        ...
        'page.imagewithtext': {
            ...
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'section_image': ('feincms.module.medialibrary.fields.MediaFileForeignKey', [], {'to': "orm['medialibrary.MediaFile']", 'null': 'True', 'blank': 'True'}),
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 12, 40)'}),
