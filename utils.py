...
class SearchHighlighter(Highlighter):
    ...
    def find_window(self, highlight_locations):
        ...
        if len(words_found) == 1:
        	distance_to_add_to_best_start = self.max_length - len(self.text_block) - words_found[0]
        	if distance_to_add_to_best_start > 0:
        		best_start = words_found[0] - distance_to_add_to_best_start
        	else:
        		best_start = words_found[0]
        	if best_start < 0:
        		best_start = 0
        	return (best_start, words_found[0] + self.max_length)
        ...
        distance_to_add_to_best_start = self.max_length - len(self.text_block) - best_start
        if distance_to_add_to_best_start > 0:
        	best_start = best_start - distance_to_add_to_best_start
        if best_start < 0:
        	best_start = 0
        return (best_start, best_end)
