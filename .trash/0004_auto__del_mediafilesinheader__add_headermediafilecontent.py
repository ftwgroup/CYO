...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'MediaFilesInHeader'
        db.delete_table('page_page_mediafilesinheader')

        # Adding model 'HeaderMediaFileContent'
        db.create_table('page_page_headermediafilecontent', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='headermediafilecontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('type', self.gf('django.db.models.fields.CharField')(default='spread', max_length=20)),
        ))
        db.send_create_signal('page', ['HeaderMediaFileContent'])


    def backwards(self, orm):
        
        # Adding model 'MediaFilesInHeader'
        db.create_table('page_page_mediafilesinheader', (
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mediafilesinheader_set', to=orm['page.Page'])),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mediafile', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(related_name='+', to=orm['medialibrary.MediaFile'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='spread', max_length=20)),
        ...
        db.send_create_signal('page', ['MediaFilesInHeader'])

        # Deleting model 'HeaderMediaFileContent'
        db.delete_table('page_page_headermediafilecontent')
    ...
    models = {
        ...
        'page.headermediafilecontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'HeaderMediaFileContent', 'db_table': "'page_page_headermediafilecontent'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mediafile': ('feincms.module.medialibrary.fields.MediaFileForeignKey', [], {'related_name': "'+'", 'to': "orm['medialibrary.MediaFile']"}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'headermediafilecontent_set'", 'to': "orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 9, 0)'}),
